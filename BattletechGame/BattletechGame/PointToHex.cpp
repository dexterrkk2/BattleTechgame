// Making a arrow that displays the arrow its self and seeing if a sepific hex is blocked. This can also be called by any scripts.
// Make it where it also checks what hex's are being passed. Also which face the player is faceing. 
